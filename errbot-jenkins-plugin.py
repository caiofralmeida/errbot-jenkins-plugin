...
class ErrbotJenkinsPlugin(BotPlugin):
    ...
    def activate(self):
        ...
        """
        super(ErrbotJenkinsPlugin, self).activate()
    ...
    def deactivate(self):
        ...
        You should delete it if you're not using it to override any default behaviour
        """
        super(ErrbotJenkinsPlugin, self).deactivate()
    ...
    def check_configuration(self, configuration):
        ...
        You should delete it if you're not using it to override any default behaviour
        """
        super(ErrbotJenkinsPlugin, self).check_configuration(configuration)
